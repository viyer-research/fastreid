...
def create_pipeline():
    ...
    detection_nn.setBlobPath(str(Path("E:/OpenVINO-Re-ID/vehicle-detection-adas-0002-2020-4.blob").resolve().absolute()))  #Works! with sie (672, 384)
    # Confidence
    ...
    reid_nn.setBlobPath(str(Path("E:/OpenVINO-Re-ID/vehicle-reid-0001-2020-4.blob").resolve().absolute()))  # Vehicle RE-ID
