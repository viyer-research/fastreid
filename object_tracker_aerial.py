...
#nnPathDefault = str((Path(__file__).parent / Path("E:/OpenVINO-Re-ID/ver-2020-4/yolo-v2-tiny-vehicle-detection-0001-2020-4.blob")).resolve().absolute())
#nnPathDefault = str((Path(__file__).parent / Path("E:/OpenVINO-Re-ID/ver-2020-4/yolo-v3-tf.blob")).resolve().absolute())
nnPathDefault = str((Path(__file__).parent / Path("E:/OpenVINO-Re-ID/Aerial/yolo_v3_tiny-aerial.blob")).resolve().absolute())
#nnPathDefault = str((Path(__file__).parent / Path("E:/OpenVINO-Re-ID/ver-2020-4/pedestrian-and-vehicle-detector-adas-0001.blob")).resolve().absolute())
...
#manip.initialConfig.setResizeThumbnail(672, 384)
# manip.initialConfig.setResize(672, 384)
...
objectTracker.setDetectionLabelsToTrack([3])  # mobilenet-ssd cars pascal-voc-classes.txt cars:7
#objectTracker.setDetectionLabelsToTrack([2])  # track cars YOLO
